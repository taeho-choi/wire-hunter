...
#ifdef WIREHUNTER_Obstacle_generated_h
...
template<> WIREHUNTER_API UClass* StaticClass<class AObstacle>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID WireHunter_Source_WireHunter_Obstacle_h
